    ...
    <section class="grid grid-cols-2 gap-20 border-t border-cream-border pt-12 px-6 md:px-20 pb-20 animate-fade-up [animation-delay:150ms]">
        ...
        <div class="flex flex-col gap-9">
            ...
            <div>
                ...
                <div class="border border-cream-border divide-y divide-cream-border">
                    <a href="#" class="flex gap-5 items-center py-4 px-4 hover:bg-cream-dark transition-colors">
            ...
            <div>
                ...
                <div class="border border-cream-border p-8 flex flex-col gap-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        {{-- Direct Gmail Link --}}
                        <a href="https://mail.google.com/mail/?view=cm&fs=1&to=lrc.upbaguio@up.edu.ph" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 bg-up-maroon text-cream text-xs font-bold tracking-widest uppercase px-6 py-4 hover:opacity-90 transition-opacity">
