<x-layout.landing>
    ...
    {{-- Staff Cards --}}
    <section class="px-6 md:px-64 pb-20 border-t border-cream-border pt-12 animate-fade-up [animation-delay:150ms]">
