...
<head>
    ...
    <style>
        ...
        /* Layout Structure - Fixed Sidebar */
        ...
        .btn-maroon { background: var(--header-maroon); color: white; font-weight: 700; width: 100%; padding: 12px; border-radius: 8px; margin-bottom: 10px; transition: 0.2s; border: none; cursor: pointer; }
...
<div class="app-wrapper">
    <aside class="sidebar">
        <div class="sidebar-brand-area">
            <img src="logo.jpg" alt="Logo" onerror="this.src='https://via.placeholder.com/35'">
            <span class="text-xl font-bold">LRC PeerConnect</span>
        </div>
        <nav class="flex-grow">
    ...
    <div class="main-content">
        <header class="top-header">
            ...
            <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center text-red-900 font-bold shadow-md">AN</div>
        </header>
        ...
        <main class="p-8">
            <div class="grid grid-cols-5 gap-4 mb-8">
                ...
                <div class="stat-card flex items-center gap-4">
                    ...
                    <div><h3 class="text-xs text-gray-400 font-bold uppercase">Sessions Today</h3><p class="text-2xl font-black">18</p></div>
                </div>
                <div class="stat-card flex items-center gap-4">
                    <i class="fa-solid fa-circle-exclamation"></i>
                    <div><h3 class="text-xs text-gray-400 font-bold uppercase">Pending</h3><p class="text-2xl font-black">5</p></div>
                </div>
                <div class="stat-card flex items-center gap-4">
                    <i class="fa-solid fa-star"></i>
                    <div><h3 class="text-xs text-gray-400 font-bold uppercase">Ratings</h3><p class="text-2xl font-black">4.9</p></div>
                </div>
                <div class="stat-card flex items-center gap-4">
                    <i class="fa-solid fa-user-graduate"></i>
                    <div><h3 class="text-xs text-gray-400 font-bold uppercase">Total Mentees</h3><p class="text-2xl font-black">75</p></div>
                </div>
            </div>
                ...
                <div class="col-span-2 space-y-8">
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <a href="#" class="text-red-800 font-bold text-sm hover:underline">View All ></a>
                        </div>
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-b last:border-none">
                                    <td class="py-4 font-bold text-gray-800">Dyoco, Daniel Joco</td>
                                    <td class="text-gray-600">Nabo, Frian Karl</td>
                                    <td class="text-gray-600">10:00 AM</td>
                                    <td><span class="bg-yellow-100 text-yellow-700 px-3 py-1 rounded-full text-xs font-bold">Upcoming</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                        <h2 class="text-xl font-bold mb-6 text-gray-800">Statistics Overview</h2>
                        <div class="grid grid-cols-2 gap-8">
                            <div>
                                <h3 class="text-gray-400 text-xs font-bold mb-4 uppercase">Sessions Overview</h3>
                                <canvas id="sessionsChart"></canvas>
                            </div>
                            <div>
                                <h3 class="text-gray-400 text-xs font-bold mb-4 uppercase">Feedback Summary</h3>
                ...
                <div class="space-y-6">
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        <div class="flex justify-between items-center mb-4 font-bold">
                            <button onclick="changeMonth(-1)" class="hover:text-red-800 transition"><i class="fa-solid fa-chevron-left"></i></button>
                            <span id="monthDisplay" class="text-gray-800"></span>
                            <button onclick="changeMonth(1)" class="hover:text-red-800 transition"><i class="fa-solid fa-chevron-right"></i></button>
                        </div>
                        ...
                        <div class="mt-4 pt-4 border-t text-center font-mono text-gray-400 text-sm" id="liveClock">00:00:00 PM</div>
                    </div>

                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        <h3 class="font-bold mb-4 text-gray-800">Quick Actions</h3>
...
<script>
    ...
    new Chart(document.getElementById('feedbackChart'), {
        ...
        data: { 
            ...
            datasets: [{ 
                data: [60, 30, 10], 
                backgroundColor: ['#1a3c2f', '#7b1d1d', '#e2e8f0'],
                borderWidth: 0
            }] 
        },
        options: { 
