<x-layout.landing :noMargin="true">
    {{-- Hero section --}}
    <section class="relative w-full xl:h-screen flex flex-col justify-between overflow-hidden animate-fade-up"
             style="background-image: url('https://cwpbwqcxlccbittkhasq.supabase.co/storage/v1/object/public/assets/images/lrc-session.png');
        ...
        <div class="relative z-10 flex flex-col justify-center flex-1
            ...
            <h2 class="text-[11px] sm:text-[13px] md:text-[14px] lg:text-[18px] xl:text-[22px]
                       font-heading tracking-[0.15rem] uppercase text-up-yellow
                       mb-2 md:mb-4 lg:mb-6 leading-snug">
                University of the Philippines Baguio
            </h2>

            <h1 class="font-heading font-bold text-cream tracking-wide
                       text-[2.2rem] sm:text-4xl md:text-5xl lg:text-6xl xl:text-8xl
            ...
            <p class="font-light leading-loose text-cream/70
                      text-xs sm:text-sm md:text-sm lg:text-base xl:text-lg
                      max-w-[90%] sm:max-w-[380px] md:max-w-[440px] lg:max-w-[500px]
    ...
    {{-- What We Offer --}}
    <section id="services" class="w-full px-6 sm:px-10 md:px-12 lg:px-20 xl:px-32 py-7 sm:py-12 md:py-16 xl:py-24 bg-white scroll-mt-20">
        {{-- Header --}}
        <div class="flex flex-col gap-1 sm:gap-2 md:gap-4 mb-4 sm:mb-6 md:mb-8">
            ...
            <h1 class="font-heading text-up-maroon text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold tracking-wider">
                What We Offer
            </h1>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-0">
            ...
            <a href="{{ route('public.services') }}"
               class="group flex flex-col px-6 sm:px-8 md:px-10 lg:px-12 py-8 sm:py-10
                      border-b sm:border-b-0 sm:border-r border-cream-dark
                      transition-colors hover:bg-cream-dark/30">
                <img src="https://cwpbwqcxlccbittkhasq.supabase.co/storage/v1/object/public/assets/images/landing-carousel/Image-7.jpeg"
                     alt="One on One Tutorial Session"
                     class="w-full h-40 sm:h-44 md:h-48 object-cover rounded-sm mb-5 border border-cream-border">
                ...
                <div class="text-xs sm:text-sm lg:text-base leading-7 font-light mb-1 md:mb-3">
                ...
                <div class="hidden lg:flex items-center gap-1 text-up-maroon opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200">
                    Read more
            ...
            <a href="{{ route('public.services') }}#group-session"
               class="group flex flex-col px-6 sm:px-8 md:px-10 lg:px-12 py-8 sm:py-10
                      ...
                      transition-colors hover:bg-cream-dark/30">
                <img src="https://cwpbwqcxlccbittkhasq.supabase.co/storage/v1/object/public/assets/images/landing-carousel/Image-8.jpg"
            ...
            <a href="{{ route('public.services') }}#review-classes"
               class="group flex flex-col px-6 sm:px-8 md:px-10 lg:px-12 py-8 sm:py-10
                      transition-colors hover:bg-cream-dark/30">
                <img src="https://cwpbwqcxlccbittkhasq.supabase.co/storage/v1/object/public/assets/images/landing-carousel/Image-6.jpg"
                     alt="Review Class"
                     class="w-full h-40 sm:h-44 md:h-48 object-cover rounded-sm mb-5 border border-cream-border">
    ...
    {{-- How It Works --}}
    <section class="w-full px-6 sm:px-10 md:px-16 lg:px-28 xl:px-52 py-14 sm:py-16 md:py-20 bg-up-green">
        {{-- Header --}}
        <div class="flex flex-col gap-4 mb-10 md:mb-12 text-center">
            ...
            <h2 class="font-heading text-cream text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold tracking-wider">
                Three Simple Steps
            </h2>
        </div>

        {{-- Steps --}}
        <div class="flex flex-col sm:flex-row items-stretch justify-center gap-6 sm:gap-4 md:gap-6 text-white">

            {{-- Step 1 --}}
            <a href="{{ $dashboardUrl }}"
               class="group w-full sm:flex-1 max-w-sm mx-auto flex flex-col items-center px-8 sm:px-6 md:px-8 lg:px-10 py-10 sm:py-12
                      border border-up-yellow/25 no-underline transition-all duration-300
                      hover:border-up-yellow hover:bg-white/5">
                <span class="material-symbols-outlined text-4xl sm:text-5xl text-up-yellow/70 mb-5 sm:mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:text-up-yellow">login</span>
                <div class="text-[10px] sm:text-xs md:text-sm text-up-yellow tracking-[0.2em] font-semibold uppercase mb-2">Step 1</div>
                <div class="font-heading text-xl sm:text-xl md:text-2xl text-cream font-medium tracking-wider mb-4">Login</div>
                ...
                <div class="text-xs sm:text-sm md:text-base leading-7 font-light text-cream/60 text-center">
                    Sign in with your UP email to access the booking system, browse available mentors and check session schedules.
                </div>
            </a>

            {{-- Arrow --}}
            <span class="material-symbols-outlined text-up-yellow/40 text-3xl flex-shrink-0 rotate-90 sm:rotate-0 self-center">arrow_forward</span>
            ...
            <a href="{{ $bookUrl }}"
               class="group w-full sm:flex-1 max-w-sm mx-auto flex flex-col items-center px-8 sm:px-6 md:px-8 lg:px-10 py-10 sm:py-12
                      border border-up-yellow/25 no-underline transition-all duration-300
                      hover:border-up-yellow hover:bg-white/5">
                <span class="material-symbols-outlined text-4xl sm:text-5xl text-up-yellow/70 mb-5 sm:mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:text-up-yellow">schedule</span>
                <div class="text-[10px] sm:text-xs md:text-sm text-up-yellow tracking-[0.2em] font-semibold uppercase mb-2">Step 2</div>
                <div class="font-heading text-xl sm:text-xl md:text-2xl text-cream font-medium tracking-wider mb-4">Schedule</div>
                <span class="block w-8 h-px bg-up-yellow/40 mb-4 transition-all duration-300 group-hover:w-12 group-hover:bg-up-yellow/60"></span>
                <div class="text-xs sm:text-sm md:text-base leading-7 font-light text-cream/60 text-center">
            ...
            {{-- Step 3 --}}
            <div class="group w-full sm:flex-1 max-w-sm mx-auto flex flex-col items-center px-8 sm:px-6 md:px-8 lg:px-10 py-10 sm:py-12
                        border border-up-yellow/25 transition-all duration-300
                        hover:border-up-yellow hover:bg-white/5">
                <span class="material-symbols-outlined text-4xl sm:text-5xl text-up-yellow/70 mb-5 sm:mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:text-up-yellow">person_raised_hand</span>
                <div class="text-[10px] sm:text-xs md:text-sm text-up-yellow tracking-[0.2em] font-semibold uppercase mb-2">Step 3</div>
                <div class="font-heading text-xl sm:text-xl md:text-2xl text-cream font-medium tracking-wider mb-4">Attend</div>
                <span class="block w-8 h-px bg-up-yellow/40 mb-4 transition-all duration-300 group-hover:w-12 group-hover:bg-up-yellow/60"></span>
                <div class="text-xs sm:text-sm md:text-base leading-7 font-light text-cream/60 text-center">
    ...
    {{-- Activities --}}
    <section class="w-full px-6 sm:px-10 md:px-16 lg:px-28 xl:px-52 py-14 sm:py-16 md:py-20 bg-white1">
        {{-- Header --}}
        <div class="flex flex-col gap-4 mb-10 sm:mb-12">
            <div class="flex items-center gap-3 text-up-yellow text-xs tracking-widest font-medium pb-5 border-b border-b-cream-dark">
                <h1 class="font-heading text-up-maroon text-3xl sm:text-4xl md:text-5xl font-semibold tracking-wider">
                    Activities
                </h1>
