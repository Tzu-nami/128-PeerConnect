...
<div>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .logo-text { font-size: 1rem; font-weight: 700; white-space: nowrap; overflow: hidden; opacity: 1; max-width: 200px; transition: opacity 0.2s, max-width 0.3s; }
        ...
        .nav-item {
            ...
            white-space: nowrap; position: relative; text-align: left; background: transparent;
            border: none; width: 100%; cursor: pointer; font-size: 0.875rem; justify-content: flex-start;
        }
