        ...
        init() {
            ...
            <div class="px-6 py-5 space-y-4">
                <div>
                    ...
                    <input type="text" wire:model="newSubjectCode" placeholder="e.g. Math 54" class="form-input" maxlength="20" />
                ...
                <div>
                    ...
                    <input type="text" wire:model="newSubjectName" placeholder="e.g. Elementary Analysis II" class="form-input" maxlength="255" />
    ...
    <div x-cloak class="modal-overlay" style="display: none;" x-show="showEditModal"
        ...
        <div class="modal-box-crud max-w-md" @click.stop>
            ...
            <div class="px-6 py-5 space-y-4">
                <div>
                    <label class="form-label">Subject Code <span class="text-red-500">*</span></label>
                    <input type="text" x-model="editForm.code" class="form-input" maxlength="20" />
                    @error('editSubjectCode') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label class="form-label">Subject Name <span class="text-red-500">*</span></label>
                    <input type="text" x-model="editForm.name" class="form-input" maxlength="255" />
