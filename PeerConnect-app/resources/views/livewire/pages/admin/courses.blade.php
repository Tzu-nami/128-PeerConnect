        ...
        <div class="p-5 border-b border-gray-100 flex flex-wrap gap-3 items-center justify-between">
            ...
            <div class="flex gap-2 items-center flex-wrap">
                ...
                <button x-data="{ isOpening: false }" 
                    ...
                    class="flex items-center justify-center bg-slate-800 text-white px-4 py-1.5 rounded-lg text-xs font-bold hover:bg-black transition shadow-sm h-[34px] w-[125px] disabled:cursor-not-allowed">
