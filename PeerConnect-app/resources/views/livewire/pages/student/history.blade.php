...
<div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 animate-fade-up [animation-delay:250ms]"
         x-data="tableManager(@js($this->studentHistory))">
        ...
        <div class="p-5 border-b border-gray-100 flex flex-wrap gap-3 items-center justify-between">
            <div>
                ...
                <p class="text-xs text-gray-400 font-medium" x-text="filteredItems.length + ' Session' + (filteredItems.length !== 1 ? 's' : '') + ' found'"></p>
            </div>
            ...
            <table class="w-full text-sm text-left table-fixed">
                ...
                <template x-for="(booking, index) in paginatedItems" :key="booking.id">
                    <tr class="border-b border-gray-50 hover:bg-slate-50 transition">
                        ...
                        <td class="px-5 py-4" :title="booking.subject + ' – ' + booking.subjectName">
                            <p class="font-bold text-slate-700 text-xs truncate" x-text="booking.subject"></p>
                            <p class="text-gray-400 text-[10px] truncate" x-text="booking.subjectName"></p>
                        </td>
                        <td class="px-5 py-4" :title="booking.topic">
                            <p class="text-slate-600 text-xs truncate" x-text="booking.topic"></p>
                        </td>
                        <td class="px-5 py-4" :title="booking.mentor">
                            <p class="text-xs font-medium text-slate-700 truncate" x-text="booking.mentor"></p>
                        </td>
                        <td class="px-5 py-4">
